                ...
                <div class="container">
                    ...
                    <div class="row gutters-sm" id="edit" style="display: none">
                                        ...
                                        <div class="mt-2">
                                            <div style="display: flex; flex-direction: column; gap: 10px;">
                                                ...
                                                <form method="post" style="display: none;"
                                                    action="{{ route('user.editImageDriver', ['driver'=>$vehicleDriver]) }}"
                                                ...
                                                <form style="display: none" method="POST"
                                                    action="{{ route('user.defaultImageDriver', ['driver'=>$vehicleDriver]) }}"
                                                    id="restore">
                                                    @csrf
                                                </form>
                                                <a onclick="$('#delete').submit(); return false;"
                                                    ...
                                                    Driver</a>
                                                <form style="display: none" method="POST"
                                                    action="{{ route('user.deleteDriver', ['driver'=>$vehicleDriver]) }}"
                                                    id="delete">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                        ...
                        <div class="col-md-8">
                            <div class="card mb-3" style="border-radius:20px;">
                                <form method="post"
                                    action="{{ route('user.editBioDataDriver', ['driver'=>$vehicleDriver]) }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="float-right" style="cursor: pointer;">
