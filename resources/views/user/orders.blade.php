...
<div class="container-fluid">
    <nav aria-label="breadcrumb" class="main-breadcrumb" style="border-radius: 20px">
        <ol class="breadcrumb" style="background-color: #fff8e6; border-radius: 10px">
            ...
            <li class="breadcrumb-item active" aria-current="page">Orders for User Branch :Total of
                {{count($orders)}} Orders
            </li>
        </ol>
    </nav>
        ...
        <div class="containerV container" style="padding: 0">
            ...
            <div class="inbox_people">
                <div class="headind_srch">
                    <div class="srch_bar">
                        <div class="stylish-input-group">
                            <form action="{{route('user.orders')}}" enctype="multipart/form-data">
                ...
                <div class="inbox_chat">
                    ...
                    @if ($noUser)
                    <div class="chat_list ">
                        <a href="{{route('user.orders', ['user' => $user->ID_User])}}">
            ...
            <div style="display: none" id="addOrder">
                <div class="container" style="display: flex; justify-content: center">
                    <div class="headerAddS">
                        <form method="POST" id="addOrderForm" class="row g-3" action="{{ route('user.addOrder')}}">
                            @csrf
                ...
                <div class="container">
                    ...
                    <div class="row gutters-sm" id="edit" style="display: none">
                                        ...
                                        <div class="mt-2">
                                            <div style="display: flex; flex-direction: column; gap: 10px;">
                                                ...
                                                <form method="post" style="display: none;"
                                                    action="{{ route('user.editImageUser', ['user'=>$userProfile]) }}"
                                                ...
                                                <form style="display: none" method="POST"
                                                    action="{{ route('user.defaultImageUser', ['user'=>$userProfile]) }}"
                                                    id="restore">
                                                    @csrf
                                                </form>
                                                <a onclick="$('#delete').submit(); return false;"
                                                    ...
                                                    User</a>
                                                <form style="display: none" method="POST"
                                                    action="{{ route('user.deleteUser', ['user'=>$userProfile]) }}"
                                                    id="delete">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                        ...
                        <div class="col-md-8">
                            <div class="card mb-3" style="border-radius:20px;">
                                <form method="post"
                                    action="{{ route('user.editBioDataUser', ['user'=>$userProfile]) }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="float-right" style="cursor: pointer;">
                ...
                <div class="container">
                    <div class="headerS">
                        <h3>
                            ...
                            <a href="{{route('user.orders', ['user' => $userProfile->ID_User])}}"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Customer" class="column">
                                    <a href="{{route('user.orders', ['user' => $order->ID_User])}}">
                                        <p>{{$order->username}}</p>
                                    </a>
                                </td>
                                <td data-label="Status" class="column">
                                    @if ($order->madeByUser)
                                    <p class="btn-sm btn-success">User</p>
                                    @else
                                ...
                                <td data-label="Action" class="column">
                                    <div style="display: flex; justify-content:space-around">
                                        <a href="{{ route('user.orderDetails', ['order'=>$order]) }}" data-toggle="
