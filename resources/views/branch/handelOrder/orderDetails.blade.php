                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="margin-top: 5px">
                                ...
                                <div class="btn-sm btn-primary" style="border-radius: 5px">
                                    @else <div class="btn-sm btn-success" style="border-radius: 5px"> @endif
                                        ...
                                        $interval->days <= 1) Day @else Days @endif @else Active: {{$orderCheck->days}}
                                            @if($orderCheck->days <= 1) Day @else Days @endif Left @endif<h6
                                                class="mb-0">
                                                <strong>Period:
                                                    {{ $interval->days }} @if ($interval->days <= 1) Day @else Days
                                                        @endif </strong>
                                                        </h6>
                                    </div>
                                    @else
                                    <div class="btn-sm btn-danger">Expaired: Exceeded {{$orderCheck->days+1}}
                                        @if($orderCheck->days <= 1) Day @else Days @endif <h6 class="mb-0">
                                            <strong>Period: {{ $interval->days }} @if ($interval->days <= 1) Day @else
                                                    Days @endif </strong>
                                                    </h6>
                                    </div>
                                    @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    @if ($order->order_deliveries <= 0) <p style="width: 70%"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                            ...
                                                            <div class="alert-success"
                                                                ...
                                                                <form action="{{ route('branch.extendOrder', $order) }}"
                                                                    ...
                                                                    <div class="container headerOrder"
                                                                        ...
                                                                        <div class="container">
                                                                            <input name="expandPrice"
                                                                                style="margin: 5px" readonly type="text"
                                                                                class="form-control"
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button onclick="$('#extendOrderForm').submit();"
                                                                type="button"
                ...
                <div class="headerS widthHeader" style="width: 70%">
                    <div class="card" style="border-radius:10px;">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <div class="row"
                                style="gap: 10px; justify-content: space-between;text-transform: capitalize;">
                                        ...
                                        <form action="{{ route('branch.changeUnitCapacity', $unit) }}"
                                            ...
                                            <div>
                                                ...
                                                <input class="form-control mb-0" name="capacity" type="number"
                                                    value="{{$unit->capacity}}" min="0" max="100"
                                                    id="unitCapacityNewInput" style="margin-bottom: 20px">
                                ...
                                <div class="col-sm-5 text-secondary" id="UnitChangeBigDiv">
                                    <form action="{{ route('branch.changeOrderUnit',[$unit, $order]) }}"
                                        ...
                                        <a onclick="$('#changeOrderUnitMovingDiv').toggle('fast');"
                                            style="background-color: #66377f;width: 100%"
                                            class="btn btn-sm btn-dark">Change
                                            Order Unit</a>
                                            ...
                                            <div class="headerS mt-1" style="color: #fff">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <div class="container-fluid">
                                                        ...
                                                        @if ($unitAvaliable->ID_Category ==
                                                        $categoryAvaliable->ID_Category)
                                                        @php
                                                        $ind++;
                                                ...
                                                <div class="container" style="text-align: left">
                                                    <input hidden name="changePrice" style="margin: 5px" readonly
                                                        type="text" class="form-control" id="unitChangePayment"
                                                        value="0">
                                                    ...
                                                    <div class="mt-3">
                                                        <label for="changeUnit"><strong>Change Unit for This Order
                                                                <small>(This will add the
                                                                    ...
                                                                    price: <small
                                                                        id="finallChangePrice"></small>)</small>
                                                            </strong></label>
                                                    </div>
                                                    <div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="display: flex; gap: 5px; flex-wrap: wrap; justify-content: flex-end"
                                    ...
                                    <a data-toggle="modal"
                                        data-target="#deleteTransaction{{$transaction->ID_Transaction}}"
                                        style="text-decoration: none;cursor: pointer">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert-success"
                                                        style="padding: 10px; border-radius: 10px">
                                                        <form
                                                            action="{{ route('branch.payTransaction', $transaction) }}"
                                                            ...
                                                            <p>
                                                                <center><strong>!! This Will Pay The Order
                                                                    ...
                                                                    <br>Choose Payment Bank And Upload The Payment
                                                                    Proof.
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert-danger"
                                                        style="padding: 10px; border-radius: 10px">
                                                        <form
                                                            action="{{ route('branch.deleteTransaction', $transaction) }}"
                                                ...
                                                <div class="form-check" style="margin-bottom: 10px">
                                                    <div>
                                                        <input onclick="$('#addPaymentDelivey').show('fast');"
                                                            name="transaction"
                                                            class="checkPaymentDelivey form-check-input" type="checkbox"
                                                            value="1">
                                                        <label class="form-check-label" for="flexCheckDefault">
                                                            Include
                                                            Payment
                                    ...
                                    <div>
                                        ...
                                        <div class="btn-sm btn-primary">
                                            <h6 class="mb-0">@if ($schedule->schedule_status == 2) Done @else Active
                                                @endif:
                                                {{ $scheduleCheck->days }} @if ($scheduleCheck->days <= 1) Day @else
                                                    Days @endif Left <i data-toggle="tooltip"
                                        ...
                                        <div class="btn-sm btn-danger">
                                            <h6 class="mb-0">@if ($schedule->schedule_status == 2) Done @else Expaired
                                                @endif: Exceeded
                                                {{ $scheduleCheck->days+1 }} @if ($scheduleCheck->days <= 1) Day @else
                                                    Days @endif <i data-toggle="tooltip" title="Delivery Trip Details"
                                                    onclick="$('#orderDateDetailsPositive{{$schedule->ID_DeliverySchedule}}').toggle('fast')"
                                                    class="fas fa-arrow-down float-right"></i>
                                            </h6>
                                            <p class="mb-0" style="display: none; width: max-content"
